...
def contact():
	...
	os.system('xdg-open https://www.facebook.com/profile.php?id=100093132189048')
...
\033[1;37m----------------------------------------------
 ...
 FACEBOOK   : Anil Thapa
 DECODE BY  : ANIL DADA
\033[1;37m-----ANIL KO CMD USE GAR VAGYA REXA TERO-""")
def banner():
	print(logo)
...
def namepsw():
    ...
    if os.path.exists("data/name.xml") and os.path.getsize("data/name.xml") > 0:
        ...
        print(" [\u001b[36m•\033[1;37m] NAME VAN")

        linex()

        uname = input(" [\u001b[36m•\033[1;37m] NAME VAN : ")
    ...
    if os.path.exists("data/password.xml") and os.path.getsize("data/password.xml") > 0:
        ...
        print(" [\u001b[36m•\033[1;37m] PASSWORD HAL")

        linex()

        upass = input(" [\u001b[36m•\033[1;37m] PASSWORD HAL: ")

        linex()

        with open("data/password.xml", "w") as password_file_obj:

            password_file_obj.write()
...
def login_lagi334():
 ...
 [\u001b[36m4\033[1;37m] THEN OPEN EXTENSION COPY COOKIE""")
		...
		your_cookies = input(' [\u001b[36m•\033[1;37m] COOKIE  HAL TW: ')
		...
		with requests.Session() as r:
			...
			try:
				...
				if 'How do you want to log into Facebook?' in str(response2) or '/login/?next=' in str(response2):
					...
					animation(f'\033[0m \u001b[36m>>\033[1;37m COOKIE MELENA')
...
def menu(my_name,my_id):
	...
	if _____cowok__pink_____ in ['1']:
		...
		animation(' [✓] PASSWORD BABAL ROIXA')
		...
		animation(' [✓] TERO NAME YOO PO HOO')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r {P}[ANIL]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
...
if __name__=='__main__':
	...
	try:os.mkdir('LAH ID AAYO HAI TA')

	except:pass

	try:os.mkdir('MOJ GAR')
